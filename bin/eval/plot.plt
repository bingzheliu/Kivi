...
plot 'results/s3_cn' using 1:2  with lp linewidth 6 linecolor 1 linetype 7 title 's3', \
	 'results/s4_cn' using 1:2  with lp linewidth 6 linecolor 2 linetype 1 title 's4', \
	 'results/s6_cn' using 1:2  with lp linewidth 6 linecolor 3 linetype 3 title 's6', \
	 'results/s1_cn' using 1:2  with lp linewidth 6 linecolor 4 linetype 5 title 's1', \
	 'results/s9_cn' using 1:2  with lp linewidth 6 linecolor 5 linetype 6 title 's9', \
