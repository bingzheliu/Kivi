...
default_intent_ifdef = {"kernel_panic":"KERNEL_PANIC", "no_feasible_node":"NO_FEASIBLE_NODE","checkEvictionCycle":"CHECK_EVICTION_CYCLE", "checkBalanceNode":"CHECK_BALANCE_NODE"}
# the para are default parameters, only enabled if it's not defined
default_intent_library = {"kernel_panic": {"flag":True, "run":False, "para":{}}, "no_feasible_node": {"flag":True, "run": False, "para":{}}, \
						  "checkOscillationReplicaNum": {"flag":False, "run": True, "para":{"did":0}}, "checkMinReplicas": {"flag":False, "run": True, "para":{"did":0}}, \
...
default_intents = [{"name":"no_feasible_node"}]
...
elements_required = {"nodes" : ["id", "name", "cpu", "cpuLeft", "memory", "memLeft", "status", "labels", "score", "curScore", "curAffinity", "curTaint", "maintained"], \
