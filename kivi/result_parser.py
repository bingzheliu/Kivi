# This module parses the results/trails generated by SPIN. It is used by verifier operator.

# The follow log_level is chosen by users and decides how much information is included in the counterexamples. 
# log_level 1: only warning and critical reason that the failure happen
